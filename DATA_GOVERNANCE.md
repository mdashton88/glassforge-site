...
| 2026-03-01 | 5dcf2f2 | Space toughness formula fix (v0.10.20) | Hull bonus, SFC stepped armour, reduced scaling. 29/29 SFC baseline exact (sz 4-29). |
...
| 2026-03-01 | 206ff36 | Cost engine v2 (v0.10.19) | Per-group base curves, SFC loco adders, combat multiplier. 76% within 3× of Pinnacle. Fixed calcCostFor NaN bug. |
| 2026-03-01 | — | Cost combat cap (v0.10.20) | Diminishing returns above pos=7. Prevents astronomical costs at extreme slider positions. 594 pack vehicles audited genre-by-genre. |
